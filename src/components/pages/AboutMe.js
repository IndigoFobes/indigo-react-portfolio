  ...
  return (
    <div className="about-me container text-center py-7 px-10">
      ...
      <p className="pb-2 text-lg font-semibold text-indigo-500">
        Joyful, Creative, Curious
      </p>
      <p className="leading-7 pb-10">
        Freelance web developer based in Alpharetta, Georgia. <br /> Full-stack
        trained with a love for UI-UX design and databases. Reach out for
        inquiries!
      </p>
      <div className="px-4 rounded-full mx-auto flex justify-center my-10">
        <img
          className="h-60 w-60 rounded-full align-middle object-cover object-top mb-10"
          src={indigo}
